 ...
 * Company:cisetech
 */
public class FadeView2 extends View{
    ...
    public FadeView2(Context context) {
        this(context, null);
    }

    public FadeView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FadeView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setmText(String title) {
        this.mText=title;
    }
